...
export const PrismaticJoint = defineComponent({
  name: 'PrismaticJoint',
  props: {
    body1: {
  ...
  setup(props) {
    ...
    if (!physics) {
      throw new Error('@vue-three/rapier: <PrismaticJoint> must be placed inside a <Physics> component')
    }
    ...
    function createJoint() {
      ...
      const jointData = rapier.JointData.prismatic(
        ...
        { x: props.axis[0], y: props.axis[1], z: props.axis[2] },
      )
