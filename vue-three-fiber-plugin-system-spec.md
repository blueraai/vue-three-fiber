...
Implement a **root-scoped plugin system** in `@vue-three/fiber` with two integration modes:
...
- `[@vue-three/postprocessing] Missing dependency "@vue-three/drei"`
- `[@vue-three/rapier] setup failed: ...`
- `[@vue-three/postprocessing] dispose failed: ...`
...
Public types exported from `@vue-three/fiber`:
...
- `name` must be globally unique and package-like, e.g. `@vue-three/drei`
...
## 11. Full implementation plan: `@vue-three/postprocessing`
...
## 12. Full implementation plan: `@vue-three/rapier`
...
## 13. Full implementation plan: `@vue-three/drei`
...
- scene authored with `@vue-three/fiber`
- helper/material loading via `@vue-three/drei`
- grading/composer via `@vue-three/postprocessing`
