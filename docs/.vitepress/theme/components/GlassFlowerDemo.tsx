import { Canvas, useFrame, useLoader, useObjectRef } from '@vue-three/fiber'
import { Environment, OrbitControls } from '@vue-three/drei'
            ...
            h(
              ...
              [
                ...
                h(
                  'div',
                  null,
                  'Docs-hosted showcase using the canonical docs source with local GLTF assets, HDRI lighting, and a stable physically-based material setup.',
                ),
              ],
            ),
        },
