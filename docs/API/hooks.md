...
If you need more control you may pass a numerical `renderPriority` value. This will cause Vue Three Fiber to disable automatic rendering altogether. It will now be your responsibility to render, which is useful when you're working with effect composers, heads-up displays, etc.
