---
title: Plugin System
description: Extend Vue Three Fiber with a composable, dependency-aware plugin system.
---

# Plugin System

Vue Three Fiber includes a root-scoped plugin system that lets packages hook into the renderer lifecycle, provide values to the component tree, and register Three.js extensions — all without tight coupling to Canvas internals.

> [!TIP]
> The plugin system is the recommended way to integrate ecosystem packages like [`@vue-three/drei`](/ecosystem/drei), [`@vue-three/postprocessing`](/ecosystem/postprocessing), and [`@vue-three/rapier`](/ecosystem/rapier).
...
```ts
import { defineFiberPlugin } from '@vue-three/fiber'
...
export const effectsPlugin = defineFiberPlugin({
  name: 'my-effects',
  requires: ['@vue-three/postprocessing'],
  setup(ctx) {
...
import { createDreiPlugin } from '@vue-three/drei'
import { createPostprocessingPlugin } from '@vue-three/postprocessing'
...
import { registerFiberPlugin } from '@vue-three/fiber'
import { dreiFiberPlugin } from '@vue-three/drei'
...
- [`@vue-three/drei`](/ecosystem/drei) — controls, loaders, staging, helpers
- [`@vue-three/postprocessing`](/ecosystem/postprocessing) — GPU postprocessing effects
- [`@vue-three/rapier`](/ecosystem/rapier) — physics simulation
