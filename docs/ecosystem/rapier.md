...
description: Vue-native physics simulation for Vue Three Fiber using Rapier.
---

# @vue-three/rapier

Declarative rigid-body physics for Vue Three Fiber, powered by [Rapier](https://rapier.rs/).
...
`@vue-three/rapier` is included in the monorepo at `packages/rapier/`. It is not yet published to npm — see [Installation](/getting-started/installation) for the local workspace setup.
...
```ts
import { createRapierPlugin } from '@vue-three/rapier'
...
import { rapierFiberPlugin } from '@vue-three/rapier'
...
import { Physics, RigidBody, CuboidCollider } from '@vue-three/rapier'
</script>
...
```ts
import { useRapier } from '@vue-three/rapier'
...
```ts
import { useRigidBody } from '@vue-three/rapier'
...
```ts
import { useCollider } from '@vue-three/rapier'
...
```ts
import { useBeforePhysicsStep, useAfterPhysicsStep } from '@vue-three/rapier'
